...
ME_CONFIGURE          ?= \"me -d -q -platform macosx-x64-openssl -configure . --with openssl -gen make\"
ME_CONFIGURED         ?= 1
ME_DEBUG              ?= 1
...
$(BUILD)/obj/action.o: \
	...
	$(CC) -c -o $(BUILD)/obj/action.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/action.c
...
$(BUILD)/obj/alloc.o: \
	...
	$(CC) -c -o $(BUILD)/obj/alloc.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/alloc.c
...
$(BUILD)/obj/auth.o: \
	...
	$(CC) -c -o $(BUILD)/obj/auth.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/auth.c
...
$(BUILD)/obj/cgi.o: \
	...
	$(CC) -c -o $(BUILD)/obj/cgi.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/cgi.c
...
$(BUILD)/obj/crypt.o: \
	...
	$(CC) -c -o $(BUILD)/obj/crypt.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/crypt.c
...
$(BUILD)/obj/file.o: \
	...
	$(CC) -c -o $(BUILD)/obj/file.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/file.c
...
$(BUILD)/obj/fs.o: \
	...
	$(CC) -c -o $(BUILD)/obj/fs.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/fs.c
...
$(BUILD)/obj/goahead.o: \
	...
	$(CC) -c -o $(BUILD)/obj/goahead.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/goahead.c
...
$(BUILD)/obj/gopass.o: \
	...
	$(CC) -c -o $(BUILD)/obj/gopass.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/utils/gopass.c
...
$(BUILD)/obj/http.o: \
	...
	$(CC) -c -o $(BUILD)/obj/http.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/http.c
...
$(BUILD)/obj/js.o: \
	...
	$(CC) -c -o $(BUILD)/obj/js.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/js.c
...
$(BUILD)/obj/jst.o: \
	...
	$(CC) -c -o $(BUILD)/obj/jst.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/jst.c
...
$(BUILD)/obj/options.o: \
	...
	$(CC) -c -o $(BUILD)/obj/options.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/options.c
...
$(BUILD)/obj/osdep.o: \
	...
	$(CC) -c -o $(BUILD)/obj/osdep.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/osdep.c
...
$(BUILD)/obj/rom.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rom.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/rom.c
...
$(BUILD)/obj/route.o: \
	...
	$(CC) -c -o $(BUILD)/obj/route.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/route.c
...
$(BUILD)/obj/runtime.o: \
	...
	$(CC) -c -o $(BUILD)/obj/runtime.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/runtime.c
...
$(BUILD)/obj/socket.o: \
	...
	$(CC) -c -o $(BUILD)/obj/socket.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/socket.c
...
$(BUILD)/obj/test.o: \
	...
	$(CC) -c -o $(BUILD)/obj/test.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" test/test.c
...
$(BUILD)/obj/time.o: \
	...
	$(CC) -c -o $(BUILD)/obj/time.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/time.c
...
$(BUILD)/obj/upload.o: \
	...
	$(CC) -c -o $(BUILD)/obj/upload.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -D_FILE_OFFSET_BITS=64 -D_FILE_OFFSET_BITS=64 $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/upload.c
